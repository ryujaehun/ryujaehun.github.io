# 8. How several ranks share one ledger
...
(`python/minisgl/scheduler/io.py:124-130`). It is the same rule as the acks in
...
directly (`python/minisgl/distributed/impl.py:25-26`, `:45-48`), and the call site
...
(`python/minisgl/message/utils.py:20-35`): no separate schema, just a rule for
