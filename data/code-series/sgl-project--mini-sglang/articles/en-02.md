# 2. Req and Batch: the ledger for one request
...
happens at `python/minisgl/scheduler/prefill.py:56` and the return at
`python/minisgl/scheduler/scheduler.py:200-202`. The one thing worth remembering
...
There is exactly one call site, `python/minisgl/scheduler/scheduler.py:232`. So
