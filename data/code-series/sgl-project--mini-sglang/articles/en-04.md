# 4. Paged allocation, and a page table that holds raw locations
...
chapter 2 (`python/minisgl/core.py:100-104`, "this table always treat page_size =
...
(`tests/core/test_cache_allocate.py:61-80`). One more path checks the same family
