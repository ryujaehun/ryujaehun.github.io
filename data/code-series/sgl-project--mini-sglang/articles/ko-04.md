# 4. 페이지 할당과 raw location을 담는 page table
...
(`python/minisgl/core.py:100-104`, "this table always treat page_size = 1") 이
...
(`tests/core/test_cache_allocate.py:61-80`). 같은 불변식을 실행 중에도 점검하는
경로가 하나 더 있다.
