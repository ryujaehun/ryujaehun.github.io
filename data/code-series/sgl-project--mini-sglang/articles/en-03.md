# 3. The budget behind a prefill batch, and chunked prefill
...
— `python/minisgl/scheduler/prefill.py:130-136`

`token_budget` caps **how many tokens this batch will compute**. It comes from
`max_extend_tokens`, which defaults to 8192
(`python/minisgl/scheduler/config.py:16`,
`python/minisgl/scheduler/scheduler.py:72`).
...
— `python/minisgl/scheduler/decode.py:27-30`
...
— `python/minisgl/scheduler/prefill.py:39-56`
...
— `python/minisgl/scheduler/prefill.py:57-61`
...
— `python/minisgl/scheduler/prefill.py:72-77`
...
— `python/minisgl/scheduler/prefill.py:96-102`
...
— `python/minisgl/scheduler/prefill.py:150`
...
— `python/minisgl/scheduler/prefill.py:139-147`
...
— `python/minisgl/scheduler/scheduler.py:219-224`
