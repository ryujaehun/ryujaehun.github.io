...
이 방식은 `const Foo&`로 전달하는 것만큼 효율적이며 null 값을 지원합니다. 포인터 대신 const 참조를 사용할 때에 대한 자세한 내용은 [팁 #116](/posts/abseil-tip-116-%ED%95%A8%EC%88%98-%EC%9D%B8%EC%9E%90%EC%97%90%EC%84%9C-%EC%B0%B8%EC%A1%B0-%EC%82%AC%EC%9A%A9-%EC%8B%9C-%EC%A3%BC%EC%9D%98%EC%82%AC%ED%95%AD/)을 참조하세요.
