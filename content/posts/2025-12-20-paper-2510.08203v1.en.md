...
| Consolidation dynamics in pre-training   | Scratch training on LLaMA-3.1-8B arch: **1.5B Params (2 layers)**,<strong> 8B Params (32 layers)</strong>(source: §4.1) | SlimPajama-627B<strong> 627B tokens / 1 epoch </strong> (source: §4.1)                       | Fig.8, Fig.9        |
