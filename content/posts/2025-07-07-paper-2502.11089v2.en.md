...
* **Compute bottleneck**: an analysis shows that **attention** computation alone accounts for <strong>70 – 80 %</strong> of total latency when decoding 64k tokens.
...
> In short, the experiments prove that <strong>NSA is the first “natively trainable sparse attention” to catch all three rabbits — speed, memory, and accuracy — at once</strong>.
