...
여기서 `foo`와 `bar`의 내용은 `foobar`에 배치되기 전에 임시 위치에 복사되어야 합니다. (더 자세한 내용은 [Tip of the Week #77: Temporaries, moves, and copies](/posts/abseil-tip-77-%EC%9E%84%EC%8B%9C-%EA%B0%9D%EC%B2%B4-%EC%9D%B4%EB%8F%99-%EB%B3%B5%EC%82%AC/)을 참조하세요.)
