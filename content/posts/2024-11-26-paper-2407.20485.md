...
#### 개요
A2SF는 Transformer Decoder 모델에서 사용되는 <strong>Accumulative Attention Score (A2S)</strong>에 "Forgetting Factor"를 추가하여, 과거 생성된 토큰들의 중요도가 현재 토큰에 과도하게 영향을 미치는 문제를 해결합니다. 이를 통해 토큰의 중요도를 공정하게 평가하고, 불필요한 토큰을 정확히 제거할 수 있습니다.
