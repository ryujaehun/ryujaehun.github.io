...
- linux
date: '2021-02-11'
description: gzip 은 코어 하나만 씁니다. pigz 로 여러 코어를 써서 tar 압축을 빠르게 하는 설치와 사용법입니다.
slug: ubuntu에서-parallel-gzip사용하여-빠르게-압축하기pigz
title: pigz 로 여러 코어를 써서 빠르게 압축하기 (우분투)
---
## Pigz? 
