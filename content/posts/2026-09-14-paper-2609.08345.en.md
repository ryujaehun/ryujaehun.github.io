...
**Table 2. **Performance Comparison**. CoVeR compared to ExpCText*Voxelization* and ExpDText*Learned Importance* methods on 12-view ScanQA , OpenEQA , and SQA3D . **Avg.** is over benchmarks, while **Rel.** is avg. % of performance maintained. Higher is better.**
