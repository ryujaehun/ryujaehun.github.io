...
이 논문에서 설명하는 **팩터 투자 알고리즘**의 핵심 과정은 특정 팩터에 노출된 포트폴리오를 구성하는 것입니다. 이를 위해 MSCI 팩터 인덱스를 활용하는 방법이 제시됩니다. 예를 들어 <strong>저변동성 팩터(Minimum Volatility Factor)</strong>를 사용하는 과정은 다음과 같습니다:
