...
---
![LLVM 프로젝트 로고인 은색 와이번(용) 그림](/assets/images/llvm.jpeg)
...
![opt -view-cfg 로 뽑은 matmul 함수의 제어 흐름 그래프. entry 에서 for.cond, for.body, for.cond1, for.body3 으로 삼중 루프가 중첩되고 각 블록 안에 LLVM IR 명령이 적혀 있다](/assets/images/unroll_and_jam.png)
...
![Polly 문서에 실린 LLVM 패스 파이프라인 도식](https://releases.llvm.org/8.0.0/tools/polly/docs/_images/LLVM-Passes-all.png)
