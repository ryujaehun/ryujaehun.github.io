...
이렇게 하면 API가 더 유연해지고, `string`으로 불필요한 변환을 피함으로써 성능이 개선될 수 있습니다. ([팁 #1](/posts/abseil-tip-1-string_view%EC%9D%98-%ED%99%9C%EC%9A%A9-%EB%B0%A9%EB%B2%95%EA%B3%BC-%EC%9D%B4%EC%A0%90/) 참조)
