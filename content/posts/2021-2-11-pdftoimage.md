...
- linux
date: '2021-02-11'
description: 변환 사이트에 올리기 곤란한 PDF 를 pdftoppm 으로 직접 변환합니다. 해상도(-r), 흑백(-gray), png/jpeg/tiff 출력 옵션을 정리했습니다.
slug: ubuntu-pdf-를-이미지로-변환
title: 우분투 터미널에서 PDF 를 이미지로 변환하기 (pdftoppm)
---
## About
