...
>  **S\*<sub>i</sub> = ∑<sub>j = 1</sub><sup>k</sup> S<sub>i,j</sub> (Eq. 6)<strong>, expanding the low resolution of scalar RMs by k times (e.g., 10 → 320) and lifting accuracy by </strong>+4.9 pp**.
...
| **S\*<sub>i</sub><strong> | </strong>Final score** summed over all samples                                  |
...
| Sample 1         | 9               | 1               |
| Sample 2         | 8               | 2               |
| **Sum (S\*)<strong> | </strong>17<strong>          | </strong>3**           |
