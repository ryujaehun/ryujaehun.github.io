...
아래는 <strong>"이번 주의 팁 #232: 변수 선언 시 `auto`를 언제 사용할 것인가"</strong>에 대한 한글 번역입니다.
...
Google의 스타일 가이드는 <strong>[타입 추론(`auto`) 사용](https://google.github.io/styleguide/cppguide.html#Type_deduction)</strong>에 대해 이렇게 권장합니다:
...
- [Tip #4](https://abseil.io/tips/4): 자동화를 위한 `auto`  
- [Tip #44](https://abseil.io/tips/44): `auto`의 수식 지정