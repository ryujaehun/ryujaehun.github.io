...
**DeepSeek-Prover-V2's 'secret weapon' is a *single* reward function that layers a 'CoT – Proof Consistency Reward' onto GRPO (Group-Relative Policy Optimization).<strong> This mechanism forcibly aligns the natural-language Chain-of-Thought (CoT) sketch with the final Lean proof structure, and is the decisive factor lifting MiniF2F-test Pass@32 from the </strong>70s% to 82.4% (+11.6pp)**.
