...
![SampleAttention 의 세 단계를 그린 그래프 세 개. 위는 키 중요도 점수와 상위 95% CRA 임계선, 가운데는 마지막 800 토큰만 남긴 지역 윈도 마스크, 아래는 둘을 합친 최종 희소 어텐션 마스크다](/assets/images/20250324.png)
...
SampleAttention의 진짜 강점은 <strong>"무작정 희소하게 만들지 않고, 똑똑하게 희소하게 만든다"</strong>는 점입니다. 기존 방식은 다음과 같은 문제를 가졌습니다:
