...
<strong>표 8. TPFs for the SFT checkpoint and its RL-post-trained counterpart, evaluated using the diffusion weights trained for the SFT checkpoint. </strong>Even after extensive RL post-training, the SFT diffusion adapters retained their speedup<strong>, with only a $6\%$ reduction in TPFs.</strong>
