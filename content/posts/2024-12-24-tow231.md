...
아래는 <strong>"이번 주의 팁 #231: 여기와 저기 사이 – 간과되기 쉬운 몇 가지 알고리즘"</strong>에 대한 한글 번역입니다.
...
모든 함수는 <strong>`constexpr`</strong>로 정의되어 있어 **컴파일 타임**과 **런타임** 모두에서 사용할 수 있습니다.  
...
> **주의:**  
> `std::clamp`는 <strong>참조(reference)</strong>를 반환합니다.  
...
<strong>외삽(extrapolation)</strong>도 가능합니다:
